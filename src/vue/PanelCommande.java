...
public class PanelCommande extends PanelPrincipal implements ActionListener {
    ...
    public PanelCommande(int idUser) {
        ...
        // Installation de la JTable pour afficher les commandes
        ...
        // Installation du bouton "Annuler la commande"
        ...
        this.tableCommandes.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (ligne >= 0) {
                    btAnnulerCommande.setEnabled(true); // Activer le bouton si une commande est sélectionnée
                }
            }
        });
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.btAnnulerCommande) {
            ...
            if (ligne >= 0) {
                int idCommande = (int) this.tableauCommandes.getValueAt(ligne, 0); // Récupérer l'ID de la commande
                int choix = JOptionPane.showConfirmDialog(this, "Voulez-vous vraiment annuler cette commande ?",
                        "Confirmation", JOptionPane.YES_NO_OPTION);
                if (choix == JOptionPane.YES_OPTION) {
                    Controleur.deleteCommande(idCommande); // Supprimer la commande
                    this.tableauCommandes.setDonnees(this.obtenirDonnees(idCommande)); // Actualiser l'affichage
